...
<link rel="stylesheet" href="http://192.168.0.68/static/css/default.css">
<script src="http://192.168.0.68/static/js/init.js"></script>

<%-- part 파라미터의 유무에 따라 추가 css,js  --%>
<link rel="stylesheet" href="http://192.168.0.68/static/css/${part }.css">
<script src="http://192.168.0.68/static/js/${part }.js"></script>
